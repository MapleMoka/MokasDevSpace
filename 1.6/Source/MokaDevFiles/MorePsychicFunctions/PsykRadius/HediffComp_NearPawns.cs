...
{
    public class HediffComp_NearPawns : HediffComp
    {
        public HediffCompProperties_NearPawns Props => (HediffCompProperties_NearPawns)props;
        ...
        public override void CompPostTick(ref float severityAdjustment)
        {
            ...
            int num = CountNearbyPawns(parent.pawn);
        ...
        public int CountNearbyPawns(Pawn pawn)
        {
