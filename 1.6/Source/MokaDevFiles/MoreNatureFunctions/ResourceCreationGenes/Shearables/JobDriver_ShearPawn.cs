...
namespace MFM
{
    public class JobDriver_ShearPawn : JobDriver_GatherAnimalBodyResources
    {
        ...
        {
            this.FailOnDespawnedNullOrForbidden<JobDriver_ShearPawn>(TargetIndex.A);
            this.FailOnDowned<JobDriver_ShearPawn>(TargetIndex.A);
            this.FailOnNotCasualInterruptible<JobDriver_ShearPawn>(TargetIndex.A);
