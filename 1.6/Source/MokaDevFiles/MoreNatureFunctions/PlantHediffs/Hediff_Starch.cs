...
{
    public class Hediff_Starch : HediffWithComps
    {
        private HediffComp_Starch cachedComp;
        private float cachedStarch = -1f;
        private HediffStage cachedStage;

        private HediffComp_Starch Comp
        {
            get => this.cachedComp ?? (this.cachedComp = this.TryGetComp<HediffComp_Starch>());
        }
