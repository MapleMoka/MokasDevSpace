...
{
    public class CompAbilityEffect_LightCost : CompAbilityEffect
    {
        public new CompProperties_AbilityLightCost Props => (CompProperties_AbilityLightCost)props;

        private bool HasEnoughHemogen
        {
            get
            {
                Gene_Resource_Light gene_Hemogen = parent.pawn.genes?.GetFirstGeneOfType<Gene_Resource_Light>();
