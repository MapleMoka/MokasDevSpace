...
{
    internal class HediffComp_ToxicRegen : HediffComp
    {
        ...
        private Gene_Resource_Pollution lightStore => cachedLightGene ?? (cachedLightGene = base.Pawn.genes.GetFirstGeneOfType<Gene_Resource_Pollution>());


        public HediffCompProperties_ToxicRegen Props => (HediffCompProperties_ToxicRegen)this.props;
