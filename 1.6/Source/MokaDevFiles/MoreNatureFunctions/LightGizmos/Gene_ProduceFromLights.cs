...
{
    internal class Gene_ProduceFromLights : Gene
    {
        ...
        private Gene_Resource_Light cachedLightGene;

        private Gene_Resource_Light lightGene => cachedLightGene ?? (cachedLightGene = base.pawn.genes.GetFirstGeneOfType<Gene_Resource_Light>());
