...
namespace MokaDevSpace
{
    ...
    public class GeneGizmo_ResourceLight : GeneGizmo_Resource
    {
        ...
        public GeneGizmo_ResourceLight(Gene_Resource_Light gene, List<IGeneResourceDrain> drainGenes, Color barColor, Color barhighlightColor)
