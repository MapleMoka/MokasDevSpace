...
{
    public class Gene_Resource_Light : Gene_Resource, IGeneResourceDrain
    {
        ...
        public override void TickInterval(int delta)
        {
            ...
            {
                if (pawn.genes.HasActiveGene(MCM_DefOf.Moka_LightFatal) && pawn.health.hediffSet?.GetFirstHediffOfDef(MCM_DefOf.Moka_LightCravingFatal) == null)
                    pawn.health.AddHediff(MCM_DefOf.Moka_LightCravingFatal);
                else if(!(pawn.genes.HasActiveGene(MCM_DefOf.Moka_LightFatal)) && pawn.health.hediffSet?.GetFirstHediffOfDef(MCM_DefOf.Moka_LightCraving) == null)
                {
                    pawn.health.AddHediff(MCM_DefOf.Moka_LightCraving);
                }
            }
