...
namespace MokaDevSpace
{
    ...
    public class GeneGizmo_ResourceLumen : GeneGizmo_Resource
    {
        ...
        public GeneGizmo_ResourceLumen(Gene_Resource_Lumens gene, List<IGeneResourceDrain> drainGenes, Color barColor, Color barhighlightColor)
