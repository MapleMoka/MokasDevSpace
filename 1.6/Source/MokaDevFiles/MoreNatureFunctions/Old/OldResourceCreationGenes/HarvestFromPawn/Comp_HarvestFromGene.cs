...
namespace MFM
{
    internal class Comp_HarvestFromGene : CompHasGatherableBodyResource
    {
        ...
        public CompProperties_HarvestFromGene Props => (CompProperties_HarvestFromGene)((ThingComp)this).props;
