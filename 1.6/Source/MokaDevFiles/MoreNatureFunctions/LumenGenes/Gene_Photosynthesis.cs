...
{
    internal class Gene_Photosynthesis : Gene
    {
        ...
        private Gene_Resource_Lumens lightGene => cachedLightGene ?? (cachedLightGene = base.pawn.genes.GetFirstGeneOfType<Gene_Resource_Lumens>());
        ...
        public override void ExposeData()
        {
            base.ExposeData();
            ext = this.def.GetModExtension<Ext_ResourceToFoodGene>();
            Scribe_Values.Look<float>(ref this.rsrcLvlRequired, "lightLevelRequired", this.ext.rsrcLvlRequired, false);
            Scribe_Values.Look<float>(ref this.foodLvlMax, "maxFoodLevel", this.ext.foodLvlMax, false);
            Scribe_Values.Look<float>(ref this.foodFillRate, "foodFillRate", this.ext.foodFillRate, false);
        }

        public Gene_Photosynthesis()
        {
