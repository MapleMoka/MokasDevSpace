...
{
    public class Hediff_XylemOld : HediffWithComps
    {
        private HediffComp_XylemOld cachedComp;
        private float cachedWater = -1f;
        private HediffStage cachedStage;

        private HediffComp_XylemOld Comp
        {
            get => this.cachedComp ?? (this.cachedComp = this.TryGetComp<HediffComp_XylemOld>());
        }
