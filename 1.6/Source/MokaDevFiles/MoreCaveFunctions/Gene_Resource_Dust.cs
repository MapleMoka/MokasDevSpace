...
{
    public class Gene_Resource_Dust : Gene_Resource, IGeneResourceDrain
    {
        ...
        public override void Notify_IngestedThing(Thing thing, int numTaken)
        {
            ...
            if (thing.def.IsMeat)
            {
                ...
                {
                    Util_CaveMethods.OffsetDust(pawn, 0.0375f * thing.GetStatValue(StatDefOf.Nutrition) * (float)numTaken);
                }
            }
        }
        ...
        //public bool dustPacksAllowed = true;

        public override void PostAdd()
        {
            if (ModLister.CheckBiotech("Dust"))
            {
                base.PostAdd();
                Reset();
            }
