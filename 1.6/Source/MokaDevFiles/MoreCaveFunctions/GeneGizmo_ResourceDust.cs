...
namespace MokaDevSpace
{
    ...
    public class GeneGizmo_ResourceDust : GeneGizmo_Resource
    {
        ...
        public GeneGizmo_ResourceDust(Gene_Resource_Dust gene, List<IGeneResourceDrain> drainGenes, Color barColor, Color barhighlightColor)
