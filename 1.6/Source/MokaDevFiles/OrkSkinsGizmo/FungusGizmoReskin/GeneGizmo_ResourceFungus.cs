...
namespace MokaDevSpace
{
    ...
    public class GeneGizmo_ResourceFungus : GeneGizmo_Resource
    {
        ...
        public GeneGizmo_ResourceFungus(Gene_Resource_Fungus gene, List<IGeneResourceDrain> drainGenes, Color barColor, Color barhighlightColor)
