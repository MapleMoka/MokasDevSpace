...
namespace MokaDevSpace
{
    ...
    public class GeneGizmo_ResourceToxons : GeneGizmo_Resource
    {
        ...
        public GeneGizmo_ResourceToxons(Gene_Resource_Toxon gene, List<IGeneResourceDrain> drainGenes, Color barColor, Color barhighlightColor)
