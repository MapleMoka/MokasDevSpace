...
{
    public class CompAbilityEffect_PollutionCost : CompAbilityEffect
    {
        public new CompProperties_AbilityPollutionCost Props => (CompProperties_AbilityPollutionCost)props;

        private bool HasEnoughHemogen
        {
            get
            {
                Gene_Resource_Pollution gene_Hemogen = parent.pawn.genes?.GetFirstGeneOfType<Gene_Resource_Pollution>();
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            Util_PollutionUtils.OffsetPollution(parent.pawn, 0f - Props.hemogenCost);
        }
