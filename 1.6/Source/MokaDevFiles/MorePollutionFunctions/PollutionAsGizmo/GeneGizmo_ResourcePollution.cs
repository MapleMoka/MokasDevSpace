...
namespace MokaDevSpace
{
    ...
    public class GeneGizmo_ResourcePollution : GeneGizmo_Resource
    {
        ...
        public GeneGizmo_ResourcePollution(Gene_Resource_Pollution gene, List<IGeneResourceDrain> drainGenes, Color barColor, Color barhighlightColor)
